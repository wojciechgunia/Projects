        ...
        <div class="details">
          <div class="Orders">
            <div class="cardHeader">
              <h2>Produkty</h2>
              <a href="pro-add-pan" class="btn">Dodaj</a>
            </div>
            <table>
              <tr>
                <td>id</td>
              ...
              $data = $db->query("SELECT * FROM `produkty`;");
              ...
              while ($row = $data->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td>$row[cenad]zł</td>
                  <td>$row[zdjecie]</td>
                  <td style="width: 120px;"><form action="pro-edit-pan" method="post"" style="float: left;"><input type="text" style="display: none;" name="id" value="$row[id]"><input class="btn" type="submit" value="edytuj"></form>
                  <form action="pro-del.php" method="post"><input type="text" style="display: none;" name="id" value="$row[id]"><input class="btn" type="submit" onclick="return confirm('Czy napewno chcesz usunąć?')" value="usuń"></form></td>
                </tr>
HI;
              }
              $db->close();
